...
ACT Lab Test Results	|Both numeric and categorical values	|search for "GGT" in ACT_Lab_Test_Results - shows with categorical filter.search for  "Albumin" in ACT_Lab_Test_Results shows up as a numeric filter
